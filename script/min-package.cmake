...
#include(${CMAKE_CURRENT_SOURCE_DIR}/source/min-api/max-api/script/git-rev.cmake)
#
#
#
...
#	include(${CMAKE_CURRENT_SOURCE_DIR}/source/min-api/max-api/script/cmakepp.cmake)
#	
...
#	endif ()
#	
#	set(C74_SCRIPT_DIR "${CMAKE_CURRENT_SOURCE_DIR}/source/min-api/max-api/script")
#
#	set(BUNDLE_IDENTIFIER "\${PRODUCT_NAME:rfc1034identifier}")
#	configure_file("${C74_SCRIPT_DIR}/Info.plist.in" "${C74_SCRIPT_DIR}/Info.plist" @ONLY)
#endif ()
#
#
